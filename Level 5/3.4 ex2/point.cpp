...
point::point(double my_x,double my_y):x(my_x),y(my_y){
    //number_of_cons++;
    //cout << "Point Constructor called: " << number_of_cons << endl;
};

point::point(const point &p1):x(p1.x),y(p1.y){
    //number_of_cons++;
    //cout << "Point Copy constructor called: " << number_of_cons << endl;
};

point::~point(){
    //number_of_des++;
    //cout << "Point Destructor called: " << number_of_des << endl;
};
